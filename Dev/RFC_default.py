...
# %%
def BF_fitting(BF, Input_folds, Output_folds, fold, pickle_file, seed): 
    """ 
    Input:      BF                Number of balancing folds                      
    ...
    for i in range(BF):
        ...
        model = RandomForestClassifier(n_jobs = 4, random_state=seed) 
...
for fold in range(len(IT_list)): 
    ...
    BF_RFC, pickle_file                      = BF_fitting(BF, Input_folds, Output_folds, fold, pickle_file, seed)
